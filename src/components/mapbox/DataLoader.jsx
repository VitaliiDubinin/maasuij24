...
//   const [pointsResponse, linksResponse, stopPointsResponse] = await Promise.all([
//     getData('entity/find-all'),
...
//     stopPointsData: stopPointsResponse.data
//   };
// };
...
//   const { data, isLoading, error } = useQuery('initialData', fetchAllData, {
//     refetchOnWindowFocus: false,
//   });

//   useEffect(() => {
//     if (data) {
//       queryClient.setQueryData('stops', data.pointsData);
